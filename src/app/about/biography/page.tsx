...
export default function Biography() {
  return (
    <section className=''>
      ...
      <p className='pb-4'>
        In the beginning, there was entropy ... Silence ... Cold vacuum ... But
        there was also some defects ... Causing a small imbalance or
        imperfection. It was dark but it was{' '}
        <span className='text-(--accent-peach)'>E</span>verything.
      </p>
      <p className='pb-4'>
        This imbalance caused the formation over many years caused the creation
        of fusion—stars across the void. From that fire more complex elements
        and later life emerged. We do not know if we are alone but we do know:
      </p>
      ...
      <p className='pb-4'>
        Quietly we became conscious. We built tools. We tamed logic. And in time
        we will <span className='text-(--accent-peach)'>C</span>ompute{' '}
        <span className='text-(--accent-peach)'>E</span>verything.
      </p>
      <p className='pb-4'>
        In the future we will merge not only companies and countries but into
        one. Because we will realise that our goal is the same. The journey may
        not end in silicon, or with energy.
      </p>
      <p className='pb-4'>
      ...
      <p>
        ...
        functional energy. Your company is no longer a logo on paper. I&apos;ts
        a waveform. A frequency. A radiant truth. We don&apos;t just build code.
        We architect convergence. We compute everything to become light.
      </p>
    </section>
  );
}
