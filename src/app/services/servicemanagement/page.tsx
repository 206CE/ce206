        ...
        services={[
          {
            ...
            description: "If you are doing something that doesn't help your company, stop doing it.",
            link: "/",
          },
          {
            title: "Iterate with feedback",
            description: "Make improvements but always make sure you have feedback as well",
            link: "/",
          },
          {
